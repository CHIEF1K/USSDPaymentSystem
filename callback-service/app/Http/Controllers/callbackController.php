...
class callbackController extends Controller
{
    ...
    private function handleSuccessfulPayment($transaction_id, $order_id, $mobile, $amount, $merchant_id, $status_code, $status_message, $transaction_no)
    {
        ...
        if ($merchant) {
            ...
            // Log the merchant's details
            Log::info("Merchant found. ID: {$merchant_id}, Name: {$merchant_name}, Phone Number: {$merchant_phone_number}");
            ...
            Log::info("SMS sent to merchant (ID: {$merchant_id}): {$successMessageToMerchant}");
            ...
            Log::info("SMS sent to user (Mobile: {$mobile}): {$successMessageToUser}");
